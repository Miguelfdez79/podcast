...
<html lang="es">
    ...
    <head>
        ...
        <script>
                ...
                function rotateAnimation(el, celeridad) {
                    ...
                    looper = setTimeout('rotateAnimation(\'' + el + '\',' + celeridad + ')', celeridad);
                    degrees++;
                    if (degrees > 359) {
                        degrees = 1;
                    }
    ...
    <body>
            ...
            <div id="containerelements">
                ...
                <div id="infousuario">
                   ...
                   ?>
                    ...
                    <audio controls autoplay>
                        ...
                        <script>rotateAnimation("disco", 18);</script>
                    </audio>
                </div>
                ...
                <div id="areamusica">
                    ...
                    <ul class="listadodemusica">       
                        ...
                        <?php
                        echo Listpodcast::listar($user->getNombre(), "Rock", "private");
                        echo Listpodcast::listar($user->getNombre(), "Pop", "private");
                        echo Listpodcast::listar($user->getNombre(), "Heavy", "private");
                        echo Listpodcast::listar($user->getNombre(), "Jazz", "private");
                        echo Listpodcast::listar($user->getNombre(), "Soul", "private");
                        echo Listpodcast::listar($user->getNombre(), "Rock", "public");
                        echo Listpodcast::listar($user->getNombre(), "Pop", "public");
                        echo Listpodcast::listar($user->getNombre(), "Heavy", "public");
                        echo Listpodcast::listar($user->getNombre(), "Jazz", "public");
                        echo Listpodcast::listar($user->getNombre(), "Soul", "public");
                        ?>
                    </ul>
        ...
        <footer>
            <div id="contenidopie">
                <div class="infopie">
                    <p id="copy">© EIDOSDESIGN ESTUDIO · 2015 · ALL RIGHTS RESERVED<span id="web">www.eidosdesign.es</span></p>
                </div>
